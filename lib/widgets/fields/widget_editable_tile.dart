...
class WGEditableTile extends StatefulWidget {
  const WGEditableTile({
    super.key,
    required this.icon,
    required this.title,
  ...
  @override
  State<WGEditableTile> createState() => _WGEditableTileState();
}

class _WGEditableTileState extends State<WGEditableTile> {
  ...
  @override
  void didUpdateWidget(covariant WGEditableTile oldWidget) {
  ...
  Widget _buildEditor() {
    final field = widget.phone
        ? WGPhoneField(
            ...
            hintText: widget.committedValue.isEmpty ? widget.title : '',
